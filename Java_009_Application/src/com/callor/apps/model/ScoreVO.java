...
public class ScoreVO {
	 ...
	 * 
	 * total, avg는 3과목의 정수를 사용하여 연산한 후 연산 결과를 저장하기 위한 변수이다
	 * 
	 ...
	 * VO 클래스의 멤버 변수를 private으로 선언하면
	 * 다른 곳에서 객체를 통해(점연결 연산자를 통해) 직접 접근이 불가능해 진다
	 * 
	 * total, avg를 private으로 선언하면 누구도 직접 total, avg에 값을 저장할 수 없다.
	 * 
	 * total, avg 변수에 담긴 값을 객체를 통해 읽기 하기 위해 getTotal(), getAvg() 메서드를 만들어 두었따.
	 * 
