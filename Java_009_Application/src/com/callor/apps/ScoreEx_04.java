...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		// 문자열형 숫자를 사칙연산이 가능한 Integer형으로 변환
		...
		// valueOf 클래스에 붙어있는 타입을 변경시켜주는 method
		...
		System.out.println();
		// 문자열 30을 integer.valueof한테 매개변수로 전달. 문자열 30을 정수 30으로 바꿔서 리턴
		// 문자열 40 ~
		// 두 값을 + 하고 println에 매개변수로 전달
		// 썩 좋은 코드는 아님. 변수가 담아서 주는 게 좋음
