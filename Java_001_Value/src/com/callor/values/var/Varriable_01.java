...
public class Varriable_01 {
	public static void main(String[] args) {
		...
		System.out.println( 30 % 40 );
		/*
		 * 위 5가지의 명령코드에서 숫자 30과 40, 그리고 연산 결과는 기억장치 어딘가에 (임시로)보관이 되어 연산 수행이 이루어진다
		 * 
		 * 그런데,
		 ...
		 * 
		 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해두고
		 * 연산할 때 그 값을 참조하여 연산을 하도록 한다면 기억장치를 효율적으로 사용할 수 있을 것이다
		 * 
		 * 이러한 개념을 발전 시킨 것을 "변수(Variable)" 이라고 한다.
		 */
	}
