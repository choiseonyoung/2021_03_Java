 ...
 * 
 * 배포 후에 사용자의 피드백을 받아서 수정하고 재배포
 * 		V1.xx, V1.xy ~
 * 
 * 사용자의 의견을 수렴하여 새로운 프로젝트를 기획, 제작, 배포
 * 		기존 프로젝트를 V1이라고 하고 새롭게 기능이 개선(추가)되어 배포된 프로젝트를
 * 		V2.xx 라고 칭하여 배포를 한다
 */

/*
 * main() method에서 배열을 만들고 값을 저장한 다음, Prime인가를 검사해서 출력
 * 
...
//		첫글자 대문자
//		이후는 camel case
//		(Uppe)rCamelCase 방식이라고 한다.

// Service 클래스
// main()에 종합적으로 작성된 코드를 method들을 만들어 분리하고 코드 관리를 쉽게 하도록 만드는 클래스(파일)들
