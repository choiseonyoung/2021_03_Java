...
public class Method_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		System.in(키보드 입력 장치)를 연결할 수 있도록 매개변수에 정보를 전달해주어야 한다
		 */
		...
		/*
		 * 어떤 수가 짝수인가를 조건검사하고
		 * 짝수이면 짝수이다 라고 표현하고 else 이면 홀수이다 라고 표현할 수 있지만
		 * 코드를 작성할 때 조건으로 명시한 이외의 경우는
		 * 가급적 ~~이 아니다 라고 표현하자
		 * 
		 * (else if 일 때는 상관없음. else 단독일 때만)
		 */
		if(int1 % 2 == 0) {
