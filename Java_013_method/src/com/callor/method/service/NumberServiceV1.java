...
public class NumberServiceV1 {
	 ...
	 * 
	 * 이 메서드는 정수형 3의 배수 또는 null값을 return 해야 하기 때문에
	 * 		Integer 형 return type을 설정해야 한다
	 * 		void 대신 Integer를 사용한다
	 * 
	 * void 대신 Integer를 사용하면
	 * 		반드시 return 명령문과 return할 값(대상)이 코드에 있어야 한다.
	...
	public Integer inputNum() {
		...
		if(rd % 3 == 0) {
			...
			return null; // 오류가 있으면 자동완성이 잘 안 돼서 미리 써놓음
		}
	}
	*/
	...
	public Integer inputNum() {
		...
		if(num2 % 3 ==0) {
			 ...
			 * 별다른 문제를 일으키거나 하지는 않지만 실제 코드가 작동될 때는
