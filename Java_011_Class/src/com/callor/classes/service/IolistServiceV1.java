...
public class IolistServiceV1 {
	...
	// return type이 명확히 결정되지 않았을 때는 void 형으로 작성을 한다
	public void selectMenu() {
		// TODO 업무선택하기 메뉴
		while(true) {
			System.out.println("=".repeat(50)); // 자바11 이상부터 가능
