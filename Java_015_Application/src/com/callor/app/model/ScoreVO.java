 ...
 */
public class ScoreVO extends Object { //  클래스 만들면 extends Object 자동으로 따라붙음
	/*
	 * java 소스코드인 클래스 파일은 보통
	 * public class 클래스명 {}
	 * 형식으로 만들어진다
	 * 이 때 extends 키워드를 사용하여 다른 클래스를 상속하면,
	 ...
	 * 
	 * 보통 클래스를 만들 때 Object로부터 상속받은 여러 메서드들 중에
